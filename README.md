...
49 plugins — 613 skills, 222 agents.
...
- **Unbundled skills** — upstream ships 419 skills and 222 agents, but only 613 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `4f4796f0bf30`.
