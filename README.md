...
49 plugins — 616 skills, 222 agents.
...
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 44 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
- **Unbundled skills** — upstream ships 422 skills and 222 agents, but only 616 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `ad4c196b933c`.
