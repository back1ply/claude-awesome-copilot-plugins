...
49 plugins — 599 skills, 224 agents.
...
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 37 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
- **Unbundled skills** — upstream ships 407 skills and 224 agents, but only 599 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `0a6e37e4e242`.
