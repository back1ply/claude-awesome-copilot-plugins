...
49 plugins — 592 skills, 224 agents.
...
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 32 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
- **Unbundled skills** — upstream ships 401 skills and 224 agents, but only 592 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `421418928715`.
