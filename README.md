...
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 38 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
Built from upstream content at commit `83561bd7d8a4`.
