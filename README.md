...
49 plugins — 606 skills, 221 agents.
...
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 41 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
- **Unbundled skills** — upstream ships 414 skills and 221 agents, but only 606 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `ca87445cb225`.
