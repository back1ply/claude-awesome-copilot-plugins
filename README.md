...
49 plugins — 617 skills, 222 agents.
...
| [`extras-data-sql`](claude-plugins/extras-data-sql/) | 28 skills, 8 agents | SQL, NoSQL, vector databases and data modelling. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
| [`extras-ai-agents`](claude-plugins/extras-ai-agents/) | 38 skills, 15 agents | Building agents: MCP servers, prompt engineering, evals and observability. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
| [`extras-git-workflow`](claude-plugins/extras-git-workflow/) | 12 skills, 3 agents | Commits, branches, code review and refactoring workflows. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
| [`extras-coding-agents`](claude-plugins/extras-coding-agents/) | 45 skills, 47 agents | General-purpose engineering agents, reviewer personas and assorted skills. Community skills and agents from github/awesome-copilot that no upstream plugin bundles. |
...
- **Unbundled skills** — upstream ships 423 skills and 222 agents, but only 617 skills belong to a curated plugin. Only the bundled ones are here.
...
Built from upstream content at commit `6c4d33b9cfca`.
