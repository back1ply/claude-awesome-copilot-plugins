...
description: "Require Azure IoT Edge documentation review before proposing edge IoT architectures or Azure implementation guidance. Applies to: **/*.bicep,**/*.tf,**/*iot*.md,**/*smart-city*.md,**/*edge*.md"
---
