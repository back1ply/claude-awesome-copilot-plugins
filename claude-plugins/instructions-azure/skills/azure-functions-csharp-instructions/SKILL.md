...
description: "Guidelines and best practices for building Azure Functions in C# using the isolated worker model. Applies to: **/*.cs, **/host.json, **/local.settings.json, **/*.csproj"
---
