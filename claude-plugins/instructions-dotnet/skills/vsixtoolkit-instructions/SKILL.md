...
description: "Guidelines for Visual Studio extension (VSIX) development using Community.VisualStudio.Toolkit. Applies to: **/*.cs, **/*.vsct, **/*.xaml, **/source.extension.vsixmanifest"
---
