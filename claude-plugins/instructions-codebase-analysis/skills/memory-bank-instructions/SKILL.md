...
description: "Memory Bank pattern: persistent project documentation under a memory-bank/ folder so the AI can resume context across sessions. Applies to: memory-bank/**"
---
