...
description: "Step-by-step guide for converting Spring Boot JPA applications to use Azure Cosmos DB with Spring Data Cosmos. Applies to: **/*.java,**/pom.xml,**/build.gradle,**/application*.properties"
---
