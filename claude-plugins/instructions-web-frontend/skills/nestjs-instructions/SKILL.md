...
description: "NestJS development standards and best practices for building scalable Node.js server-side applications. Applies to: **/*.ts, **/*.js, **/*.json, **/*.spec.ts, **/*.e2e-spec.ts"
---
