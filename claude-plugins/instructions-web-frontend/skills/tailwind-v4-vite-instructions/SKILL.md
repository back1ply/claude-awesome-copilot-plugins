...
description: "Tailwind CSS v4+ installation and configuration for Vite projects using the official @tailwindcss/vite plugin. Applies to: vite.config.ts, vite.config.js, **/*.css, **/*.tsx, **/*.ts, **/*.jsx, **/*.js"
---
