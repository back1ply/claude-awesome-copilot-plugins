...
description: "Svelte 5 and SvelteKit 2 development standards and best practices for component-based user interfaces and full-stack applications. Applies to: **/*.svelte, **/*.ts, **/*.js, **/*.css, **/*.scss, **/*.json"
---
