...
description: "Production-grade guidance for AWS AppSync Event API handlers using APPSYNC_JS runtime restrictions, utilities, modules, and datasource patterns. Applies to: **/*.{graphql,gql,vtl,ts,js,mjs,cjs,json,yml,yaml}"
---
