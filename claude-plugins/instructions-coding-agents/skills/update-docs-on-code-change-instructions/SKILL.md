...
description: "Automatically update README.md and documentation files when application code changes require documentation updates. Applies to: **/*.{md,js,mjs,cjs,ts,tsx,jsx,py,java,cs,go,rb,php,rs,cpp,c,h,hpp}"
---
