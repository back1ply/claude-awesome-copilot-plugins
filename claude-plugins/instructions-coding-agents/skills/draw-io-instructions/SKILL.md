...
description: "Use when creating, editing, or reviewing draw.io diagrams and mxGraph XML in .drawio, .drawio.svg, or .drawio.png files. Applies to: **/*.drawio,**/*.drawio.svg,**/*.drawio.png"
---
