...
description: "Instructions for developing Power Platform custom connectors with Model Context Protocol (MCP) integration for Microsoft Copilot Studio. Applies to: **/*.{json,csx,md}"
---
