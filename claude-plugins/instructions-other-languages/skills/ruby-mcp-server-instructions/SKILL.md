...
description: "Best practices and patterns for building Model Context Protocol (MCP) servers in Ruby using the official MCP Ruby SDK gem. Applies to: **/*.rb, **/Gemfile, **/*.gemspec, **/Rakefile"
---
