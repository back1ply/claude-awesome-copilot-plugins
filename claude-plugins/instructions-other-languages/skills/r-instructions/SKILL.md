---
name: r-instructions
description: "R language and document formats (R, Rmd, Quarto): coding standards and Copilot guidance for idiomatic, safe, and consistent code generation. Applies to: **/*.R, **/*.r, **/*.Rmd, **/*.rmd, **/*.qmd"
---
