...
description: "Clojure-specific coding patterns, inline def usage, code block templates, and namespace handling for Clojure development. Applies to: **/*.{clj,cljs,cljc,bb,edn.mdx?}"
---
